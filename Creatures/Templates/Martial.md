...
* If only 1 or 2 Hit Dice were added, add the trait "***Fear when alone.*** The soldier is highly succeptible to morale and mind effects when left alone. If no ally is in sight, or if all allies are further than 60ft away the solider has disvantage on WIS, INT and CHA saving throws."
...
* Add the Reaction "***Parry.*** The veteran adds their Proficiency Bonus to its AC against one melee attack that would hit it. To do so, the veteran must see the attacker and be wielding a melee weapon."
