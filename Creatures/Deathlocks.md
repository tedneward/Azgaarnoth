...
***VARIANT: Patron-Specific Spells.*** You can customize a deathlock by replacing some or all of the spells in its Spellcasting trait with spells specific to its patron. Here are examples.
...
![Deathlock-Warlock](Deathlock.png)
