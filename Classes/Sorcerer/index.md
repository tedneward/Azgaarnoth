...
* [Clockwork Soul](./ClockworkSoul.md) means the powers of neutrality call to you.
...
This is the list of spells all sorcerers have access to know. These spells are always accessible to the sorcerer to "know" (as part of their [Spells Known](#spell-versatility)). However, additional sorcerer spells are "out there" in the world, and sorcerers can augment this list with other spells if they can find some kind of exemplar or instructor to show them the new means of magic. Some of the [mage schools](../../Organizations/MageSchools/index.md) know sorcerer spells that are not on this list, and those schools can (and frequently do) share those secrets with other sorcerers... for a price.

> ### Game Notes
> The spells from the *Player's Handbook* are always available to sorcerers; however, there are many more sorcerer spells listed in the [Master Spell List](./SpellList.md). These spells are spells that any sorcerer can "know", but must find an instructor or peer to learn from.
