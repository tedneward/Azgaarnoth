...
arcane_shots = {
    '**Banishing Arrow**.': "You use abjuration magic to try to temporarily banish your target to a harmless location in the Feywild. If the arrow hits a creature, the target must also succeed on a Charisma saving throw (save DC equals 8 + your proficiency bonus + your Intelligence modifier) or be banished. While banished in this way, its speed is 0, and it is incapacitated. At the end of its next turn, the target reappears in the space it vacated or in the nearest unoccupied space if that space is occupied.",
    '**Brute Bane Arrow**.': "You weave necromantic magic into your arrow. If the arrow hits a creature, the target takes an extra 2d6 necrotic damage, and it must make a Constitution saving throw (save DC equals 8 + your proficiency bonus + your Intelligence modifier). On a failed save, the damage of the target’s attacks is halved until the start of your next turn.",
    '**Bursting Arrow**.': "You imbue your arrow with a blast of force energy drawn from the school of evocation. If the arrow hits a creature, the target and each creature within 10 feet of it also take 2d6 force damage each.",
    '**Grasping Arrow**.': "When this arrow strikes its target, conjuration magic creates grasping, poisonous brambles, which wrap around the target. If the arrow hits a creature, the target takes an extra 2d6 poison damage, its speed is reduced by 10 feet, and it takes 2d6 slashing damage the first time on each turn it moves 1 foot or more without teleporting. The target or any creature that can reach it can use its action to remove the brambles with a successful Strength (Athletics) check against your Arcane Shot save DC (8 + your proficiency bonus + your Intelligence modifier). Otherwise, the brambles last for 1 minute or until you use this option again.",
    '**Mind-Scrambling Arrow**.': "Your enchantment magic causes this arrow to temporarily beguile its target. Choose one of your allies within 30 feet of the target. If the arrow hits a creature, the target takes an extra 2d6 psychic damage, and it must succeed on a Wisdom saving throw (save DC equals 8 + your proficiency bonus + your Intelligence modifier) or it can’t attack the chosen ally or include that ally in a harmful area of effect until the start of your next turn. This effect ends early if the chosen ally deals any damage to the target.",
    '**Piercing Arrow**.': "You use transmutation magic to give your arrow an ethereal quality. When you use this option, you don't make an attack roll for the attack. Instead, the arrow fires forward in a line that is 1 foot wide and 30 feet long, before disappearing. The arrow passes harmlessly through objects, ignoring cover. Each creature in that line must make a Dexterity saving throw (save DC equals 8 + your proficiency bonus + your Intelligence modifier). On a failed save, a target takes damage as if it were hit by the arrow, plus an extra 1d6 piercing damage. On a successful save, a target takes half as much damage.",
    '**Seeking Arrow**.': "Using divination magic, you grant your arrow the ability to seek out your target, allowing the arrow to curve and twist its path in search of its prey. When you use this option, you don't make an attack roll for the attack. Instead, choose one creature you have seen in the past minute. The arrow flies toward that creature, moving around corners if necessary and ignoring three-quarters cover and half cover. If the target is within the weapon's range and there is a path large enough for the arrow to travel to the target, the target must make a Dexterity saving throw (save DC equals 8 + your proficiency bonus + your Intelligence modifier). On a failed save, it takes damage as if it were hit by the arrow, plus an extra 1d6 force damage, and you learn the target's current location. On a successful save, the target takes half as much damage, and you don't learn its location.",
    '**Shadow Arrow**.': "You weave illusion magic into your arrow, causing it to occlude your foe's vision with shadows. If the arrow hits a creature, the target takes an extra 2d6 psychic damage, and it must succeed on a Wisdom saving throw (save DC equals 8 + your proficiency bonus + your Intelligence modifier) or be unable to see anything farther than 5 feet away until the start of your next turn." 
}
...
def level3(npc):
    ...
    npc.actions.append("**Arcane Shot.** Once per turn when you fire a magic arrow from a shortbow or longbow as part of the Attack action, you can apply one of your Arcane Shot options to that arrow. You decide to use the option when the arrow hits, unless the option doesn’t involve an attack roll. You have two uses of this ability, and you regain all expended uses of it when you finish a short or long rest.")

    arcanekey = choose("Choose an Arcane Shot option:", list(arcane_shots.keys()))
    arcane = arcane_shots[arcanekey]
    npc.features.append(arcanekey + " " + arcane)

    arcanekey = choose("Choose an Arcane Shot option:", list(arcane_shots.keys()))
    arcane = arcane_shots[arcanekey]
    npc.features.append(arcanekey + " " + arcane)

# Arcane shot gains:  You gain an additional Arcane Shot option of your choice when you reach certain levels in this class: 7th, 10th, 15th, and 18th level. Each option also improves when you become an 18th-level fighter.

def level7(npc):
    npc.reactions.append("**Curving Shot.** When you make an attack roll with a magic arrow and miss, you can use a bonus action to reroll the attack roll against a different target within 60 feet of the original target.")
    npc.features.append(choose("Choose an Arcane Shot option:"), arcane_shots)

def level10(npc):
    npc.features.append(choose("Choose an Arcane Shot option:"), arcane_shots)

def level15(npc):
    npc.features.append("**Ever-Ready Shot.** Your magical archery is ever available to you when you need it most. If you roll initiative and have no uses of Arcane Shot remaining, you regain one use of it.")
    npc.features.append(choose("Choose an Arcane Shot option:"), arcane_shots)
