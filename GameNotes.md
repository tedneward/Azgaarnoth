...
* ["*Unearthed Arcana: Fighter, Rogue, and Wizard -- Psionics*](/Supplements/UA-PsychicSoulPsionics.pdf), abbreviated below as *UA: Psionics*
...
[Dragonmarked](/Supplements/UA_Dragonmarks.pdf) are generally "born wild" and, once known, very quickly hunted down by either the [Draconic Order](/Organizations/DraconicOrder/DraconicOrder.md) or the [Cult of the Wyrm](/Organizations/CultOfTheWyrm.md), to either recruit or destroy. Unlike in Eberron, dragonmarked are not part of a particular [noble House](/Organizations/Houses/Houses.md), but bloodlines do carry, and many of the noble Houses carry the dragonmark within their bloodlines... as do most of the other races by this point in Azgaarnoth's history. It is believed that the dragonmark dates back to the very earliest days of the [Eldar](/Races/Eldar.md), and that the Eldar handed out the dragonmark to favored [Firstborn](/Races/Firstborn.md) or [humans](/Races/Humans.md) as rewards for excellent service. No [Created](/Races/Created.md) have ever borne a dragonmark.


## Classes

### Barbarian
When considering barbarian paths, consider these facts:
* [Path of the Ancestral Guardian](https://www.dndbeyond.com/classes/barbarian#PathoftheAncestralGuardian) barbarians are most commonly found among the [United Hordes](/Nations/Tragekia.md) or [Yithi](/Nations/Yithi.md).
* [Path of the Beast](https://www.dndbeyond.com/classes/barbarian#PathoftheBeastUA) barbarians are often found at the fringes of civilization, in [North Bedia](/Nations/Bedia.md); some may have emerged amongst the chaos in [Chidia](/Geography/Chidia.md) but will generally want to keep their bestial nature a little disguised.
* [Path of the Berserker](https://www.dndbeyond.com/classes/barbarian#PathoftheBerserker) is actually a very common path for barbarians who join up with one of the [Mercenary Companies](/Organizations/MercCompanies/MercCompanies.md).
* [Path of the Storm Herald](https://www.dndbeyond.com/classes/barbarian#PathoftheStormHerald) barbarians can be found in quite a few places, most notably in the [Ravenlands](/Geography/Ravenlands.md), the [United Hordes](/Nations/Tragekia.md), or [North Bedia](/Nations/Bedia.md).
* [Path of the Totem Warrior](https://www.dndbeyond.com/classes/barbarian#PathoftheTotemWarrior) barbarians are usually found among the [Yithi](/Nations/Yithi.md) or [Zhi](/Nations/Zhi.md).
* [Path of the Wild Soul](https://www.dndbeyond.com/classes/barbarian#PathoftheWildSoulUA) barbarians are rare, and often found in [Zhi](/Nations/Zhi.md) owing to that nation's deep emphasis on the appreciation of beauty. Many of them journey into [Yithi](/Nations/Yithi.md), or beyond, in search of greater beauty.
* [Path of the Zealot](https://www.dndbeyond.com/classes/barbarian#PathoftheZealot) barbarians are quite common among the [Al'Uma](/Cultures/AlUma.md), particularly among the nomads, but are also frequently bound to one of the [Pantheonic gods](/Religions/Pantheon.md) or even, at times, the [Kaevarian Church](/Religions/KaevarianChurch.md), though in the latter case usually in [Dradehalia](/Nations/Dradehalia.md).
* [Path of the Depths](https://www.dndbeyond.com/classes/barbarian#PathoftheDepthsPartnered) barbarians are always (almost without exception) of the *al'maera* of the [Al'Uma](/Religions/AlUma.md), and are often sworn to destroy some enemy of the [Undersea](/Geography/Undersea.md), most often the one that caused the trauma to the barbarian in the first place.
...
### Bard
The various Bardic Colleges relate thusly in Azgaarnoth:
* The [College of Creation](/Organizations/BardicColleges/Creation.md) is quite popular among the [Al'Uma](/Religions/Al'Uma.md), though of course the bards are singing of the [Eldar](/Races/Eldar.md) when they speak of the power of creation.
* The [College of Glamour](/Organizations/BardicColleges/Glamour.md) is quite popular among the [Mercenary Companies](/Organizations/MercCompanies/MercCompanies.md) as they incite the troops to greater and greater ideals, or tell the oral histories of the companies around the campfire during the march.
...
* The [Pantheon](/Religions/Pantheon.md) is the classic multitheistic panoply of gods and goddesses arranged (more or less) by domain of the cosmos. Within the Pantheon, the following domains are available: Arcana (from *Sword Coast Adventurer's Guide*), [Life](https://www.dndbeyond.com/classes/cleric#LifeDomain), [Death](https://www.dndbeyond.com/classes/cleric#DeathDomain), [Grave](https://www.dndbeyond.com/classes/cleric#GraveDomain), [Trickery](https://www.dndbeyond.com/classes/cleric#TrickeryDomain), [War](https://www.dndbeyond.com/classes/cleric#WarDomain), [Tempest](https://www.dndbeyond.com/classes/cleric#TempestDomain), [Forge](https://www.dndbeyond.com/classes/cleric#ForgeDomain), [Knowledge](https://www.dndbeyond.com/classes/cleric#KnowledgeDomain), [Light](https://www.dndbeyond.com/classes/cleric#LightDomain), [Twilight](https://www.dndbeyond.com/classes/cleric#TwilightDomainUA), Shadow, [Nature](https://www.dndbeyond.com/classes/cleric#NatureDomain), Draconic (from *The Book of Dragons*).

* The [Al'Uma](/Religions/AlUma.md) believe that the world has entered its current state because mortals did not worship the beings that maintained it, and therefore it is mortals' responsibility to correct that, by either worship, combat, or both. Typically a [Zalabasa](/Nations/Zalabasa.md)n cleric will be of [War](https://www.dndbeyond.com/classes/cleric#WarDomain),  [Life](https://www.dndbeyond.com/classes/cleric#LifeDomain), or [Order](/Supplements/UA_OrderDomain.pdf), an [Alalihat](/Nations/Alalihat)ian cleric will be  [Life](https://www.dndbeyond.com/classes/cleric#LifeDomain), [Order](/Supplements/UA_OrderDomain.pdf), or [Light](https://www.dndbeyond.com/classes/cleric#LightDomain), an [Almalz](/Nations/Almalz.md)ish cleric will have all domains available except Death, Grave, or Twilight, and an *al'maeran* cleric will almost always choose either [Nature](https://www.dndbeyond.com/classes/cleric#NatureDomain) (with an emphasis on the sea) or [Tempest](https://www.dndbeyond.com/classes/cleric#TempestDomain).

* The [Kaevarian Church](/Religions/KaevarianChurch.md) is a monotheistic religion that actually encompasses all of the Pantheon (and the Eldar) as agents of a singular entity (Kaevar). Generally these clerics will be of  [Life](https://www.dndbeyond.com/classes/cleric#LifeDomain), [Order](/Supplements/UA_OrderDomain.pdf), [Knowledge](https://www.dndbeyond.com/classes/cleric#KnowledgeDomain), [Light](https://www.dndbeyond.com/classes/cleric#LightDomain) or [Unity](https://www.dndbeyond.com/classes/cleric#UnityDomainUA) domains, but a player wishing to be Kaevarian of a different domain can make the theological argument that since "all is Kaevar", so, too, should this domain be represented, and have solid theological ground on which to stand. Most Kaevarians would reject anything to do with chaos or evil; however, the branches of the Kaevarian Church in [Dradehalia](/Nations/Dradehalia.md) have been known to flirt with those domains as part of the [Dread Emperor](/People/DreadEmperor.md)'s plans.
...
### Fighter
Champion Martial Archetypes are frequently found in [Mercenary Companies](/Organizations/MercCompanies/MercCompanies.md). They are often not the leader of the company, but used as a rallying point during combat.
...
### [Mystic](/Supplements/Psionics_and_Mystic_V2.md)
Each of the Mystic Orders is a [Mage School](/Organizations/MageSchools/MageSchools.md). They do not advertise that they use psionics, but all magi know that these two orders do things "a little differently".

### Paladin
Paldin *Oaths of Devotion* are often sworn to the [Order of the Gold Dragon](/Organizations/DraconicOrder/Gold.md). *Oath of the Ancients* usually swear to the [Eldar](/Races/Eldar.md) alongside the elves and druids. *Oath of Vengeance* is often sworn amongst the knights of [Dradehalia](/Nations/Dradehalia.md) against the [Ulmhorde](/Nations/Ulm.md), and many are in fact following the example set by the [DreadEmperor](/People/DreadEmperor.md) in doing so.
